...
do
    ...
    hook.Add( "CanTool", "ULibEntToolCheck", tool, PRE_HOOK_RETURN )
end

hook.Add( "CanProperty", "ULibEntPropertyCheck", function( ply, toolmode, ent )
...
do
    ...
    hook.Add( "PhysgunPickup", "ULibEntPhysCheck", physgun, PRE_HOOK_RETURN )
    hook.Add( "CanPlayerUnfreeze", "ULibEntUnfreezeCheck", physgun, PRE_HOOK_RETURN )
end

hook.Add( "OnPhysgunReload", "ULibEntPhysReloadCheck", function( weapon, ply )
...
--     end
-- end
-- hook.Add( "EntityTakeDamage", "ULibEntDamagedCheck", damageCheck, PRE_HOOK )

-- This is just in case we have some horribly programmed addon that goes rampant in deleting things
hook.Add( "EntityRemoved", "ULibEntRemovedCheck", function( ent )
