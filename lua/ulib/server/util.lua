...
function ULib.replicatedWritableCvar( sv_cvar, cl_cvar, default_value, save, notify, access )
    ...
    hook.Call( ULib.HOOK_REPCVARCHANGED, nil, sv_cvar, cl_cvar, nil, nil, cvar_obj:GetString() )
...
local function clientChangeCvar( ply, command, argv )
    ...
    hook.Call( ULib.HOOK_REPCVARCHANGED, nil, sv_cvar, repcvars[ sv_cvar ].cl_cvar, ply, oldvalue, newvalue )
end
...
repCvarServerChanged = function( sv_cvar, oldvalue, newvalue )
    ...
    if repcvars[ sv_cvar ].ignore then
        ...
        hook.Call( ULib.HOOK_REPCVARCHANGED, nil, sv_cvar, repcvars[ sv_cvar ].cl_cvar, Entity( 0 ), oldvalue, newvalue )
    end
end
