...
hook.Add( "CheckPassword", "ULibBanCheck", function( _, steamid64, ip, password, clpassword, name )
...
function ULib.addBan( steamid, time, reason, name, admin )
    ...
    writeBan( t )
    hook.Call( ULib.HOOK_USER_BANNED, nil, steamid, t )
end
...
function ULib.unban( steamid, admin )
    ...
    hook.Call( ULib.HOOK_USER_UNBANNED, nil, steamid, admin )
...
hook.Add( "Initialize", "ULibLoadBans", ULib.refreshBans, PRE_HOOK )
